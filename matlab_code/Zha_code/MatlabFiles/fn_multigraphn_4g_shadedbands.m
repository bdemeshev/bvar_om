function scaleout = fn_multigraphn_4g_shadedbands(imfn,...
...
%         4th D: low band, estimate, high band, another case (in each graph).
...
for i = 1:nrow      % column: from top to bottom
   ...
   for j = 1:ncol        % row: from left to right
      ...
      hold on
      plot(t,nseries(:,[2]), '-r','LineWidth',0.9);
      plot(t,nseries(:,[4]), ':*b','LineWidth',0.8);
      hold off
