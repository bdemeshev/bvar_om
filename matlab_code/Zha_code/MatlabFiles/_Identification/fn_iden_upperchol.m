function [Ui,Vi,n0,np] = fn_iden_upperchol(lags,nvar,nexo)
%  [Ui,Vi,n0,np] = fn_iden_upperchol(lags,nvar,nexo)
%  Uppercholeski decompositions with columns corresponding to equations.  Automatically applies to all variables.
%
