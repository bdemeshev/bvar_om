function [Ui,Vi,n0,np,ixmC0Pres] = ftd_unrestricted_all(lags,nvar,nexo,indxC0Pres)
%   vlist = [127 124 93 21];    % 1: diff of GDP; 2: diff of GDP deflator 124 (consumption deflator 79); 3: R; 4:diff of nominal exchange rate.
%   varlist={'y','P','R','Ex'};
%
