...
nconstr2=nfyr;     % number of the 2nd set of constraints
...
if indxEstima
   ...
   if indxPrior
      ...
      if 1  % Liquidity effect prior on both MS and MD equations.
         [Pi,H0multi,Hpmulti,H0invmulti,Hpinvmulti] = fn_rnrprior_covres_dobs(nvar,q_m,lags,xdgel,mu,indxDummy,hpmsmd,indxmsmdeqn);
      else
