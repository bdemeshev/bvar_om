...
bs1 = 1;      % size of first block
bs2 = 2;      % size of second block of
...
VA2pr = VAx(1,1);           % prior for cov(A1(t))
VA3pr = VAx(2:3,2:3);       % prior for cov(A23(t))
...
B_s    = zeros(T,nB,nrep);
A1_s   = zeros(T,bs1,nrep+1);
A23_s  = zeros(T,bs2,nrep+1);
...
% initialise S
covS2  = TS(1)*VA1pr*kS^2;
S2     = iwishrnd(covS2,TS(1));
S(1,1) = S2;

covS3      = TS(2)*VA23pr*kS^2;
