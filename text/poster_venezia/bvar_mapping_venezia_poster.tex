...
\veryHuge \color{NavyBlue} \textbf{Classification of bees} \color{Black}\\ % Title
\Huge\textit{An Exploration of Complexity}\\[2cm] % Subtitle
\huge \textbf{Oxana Malakhovskaya, Boriska Demeshev}\\[0.5cm] % Author(s)
\huge Higher School of Economics\\[0.4cm] % University/organization
\Large \texttt{omalakhovskaya@hse.ru} --- 1 (000) 111 1111\\
\end{minipage}
%
